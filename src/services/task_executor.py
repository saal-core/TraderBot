...
class TaskExecutor:
    ...
    async def execute_plan_streaming(
        ...
        # yield self._format_event("status", {"message": f"📋 Executing plan with {len(steps)} steps..."})
        ...
        for step in steps:
            ...
            try:
                ...
                if action == "fetch_database":
                    ...
                    # yield self._format_event("content", f"✅ Step {step_id} Complete: Retrieved {len(step_result)} records.\n")
                    print(f"✅ Step {step_id} Complete: Retrieved {len(step_result)} records.")
                     ...
                     context[step_id] = step_result
                     # yield self._format_event("content", f"✅ Step {step_id} Complete: Market data fetched.\n")
