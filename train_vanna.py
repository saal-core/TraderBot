...
class MyVanna(ChromaDB_VectorStore, Ollama):
    def __init__(self, config=None):
        ...
        # Use the same persist directory as the service for consistency
        persist_dir = os.getenv("CHROMADB_PERSIST_DIRECTORY", "chroma_db")
        
        try:
            ChromaDB_VectorStore.__init__(self, config={'persist_directory': persist_dir})
...
persist_dir = os.getenv("CHROMADB_PERSIST_DIRECTORY", "chroma_db")
print(f"\n--- Vanna training complete! The index is ready in '{persist_dir}' ---")